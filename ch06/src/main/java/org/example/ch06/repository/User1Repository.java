...
// Repository는 JPA에서 데이터 액세스 객체(DAO)
@Repository
public interface User1Repository extends JpaRepository<User1, String> {
    ...
    public List<User1> findByNameStartsWith(String name); // SELECT * FROM User1 WHERE name CONTAIN
    public List<User1> findByNameEndsWith(String name);

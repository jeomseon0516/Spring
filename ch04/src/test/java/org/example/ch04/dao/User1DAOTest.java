...
class User1DAOTest {
    ...
    /*
        단위 테스트 케이스 작성
         - 애플리케이션 시나리오를 생각해서 테스트 케이스 로직 작정
    */
    ...
    void selectAll() {
        ...
        // Given
        // When
        java.util.List<User1DTO> dtoList = dao.selectAll();
    ...
    void update() {
        ...
        assertEquals(dto.toString(), modifiedUser.toString());
    }
